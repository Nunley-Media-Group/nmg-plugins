...
| File | Type | Purpose |
|------|------|---------|
| `plugins/nmg-sdlc/skills/draft-issue/SKILL.md` | Create | Skill definition with 6-step workflow |
