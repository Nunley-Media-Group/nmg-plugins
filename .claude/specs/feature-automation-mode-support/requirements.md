...
**Given** a user reads `README.md` or `.claude/steering/product.md`
...
| FR19 | Update `README.md` headless-flag section and `.claude/steering/product.md` references | Must | User-facing docs |
...
| FR22 | Rewrite historical `.claude/specs/` spec bodies to use the new terminology; directories may retain old names | Must | Git history preserves original wording |
