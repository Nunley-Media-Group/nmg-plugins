...
|----|-------------|----------|-------|
| FR1 | Scan `.claude/steering/` and compare each doc against the latest templates from `setup-steering/templates/` | Must | |
| FR2 | Scan `.claude/specs/*/` and compare each spec file against the latest templates from `write-spec/templates/` | Must | |
