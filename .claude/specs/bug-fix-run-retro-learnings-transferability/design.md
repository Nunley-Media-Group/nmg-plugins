...
| `SKILL.md` (migrate-project) Step 1 | Add a fourth template source: `run-retro/templates/retrospective.md` mapped to `.claude/steering/retrospective.md` | Closes the migration gap (FR6, AC5) |
