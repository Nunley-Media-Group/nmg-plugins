...
**Notes**: This section becomes the convention that verifying-specs reads. Place it after Testing Standards and before Environment Variables.

### T013: Add Gate Extraction to verifying-specs Step 1
...
### T014: Add Gate Execution Sub-Step 5f to verifying-specs Step 5
...
### T015: Add Gate Status Aggregation to verifying-specs Steps 7/8/9
...
- [x] Explains how gates are enforced during `/verifying-specs`
- [x] Explains the Pass/Fail/Incomplete status semantics
- [x] Mentions that existing projects can add the section via `/migrating-projects`

### T018: Add BDD Scenarios for Verification Gates

**File(s)**: `.claude/specs/feature-verifying-specs-skill/feature.gherkin`
**Type**: Modify
**Depends**: T014
**Status**: Complete
**Acceptance**:
